...
> **Explicit invocation only**: This skill should only run when the user explicitly requests it with the `release-checklist` skill. Do not auto-invoke based on context matching.
