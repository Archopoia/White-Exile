...
> **Explicit invocation only**: This skill should only run when the user explicitly requests it with the `hotfix` skill. Do not auto-invoke based on context matching.
