...
For **in-game controls, AI playtest buttons, and when the assistant may use the browser**, follow `.cursor/rules/ai-playtesting.mdc` and `.cursor/commands/playtest.md`. This skill only structures human playtest notes.
