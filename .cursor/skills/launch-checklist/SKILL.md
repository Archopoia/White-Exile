...
> **Explicit invocation only**: This skill should only run when the user explicitly requests it with the `launch-checklist` skill. Do not auto-invoke based on context matching.
...
2. **Gather project context**:
   - Read README and `docs/` for tech stack, target platforms, and team structure
